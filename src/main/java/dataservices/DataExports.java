...
//            preparedStatement.setString(1, status);
    ...
    public static String exportIoisUpdatedByLender(String requestId, String lenderName, String status) {
        String fileFullPath = "";
        Connection connection = null;
        Statement statement = null;
        boolean isError = false;
...
//            preparedStatement.setString(1, status);
            ...
            try {
                ...
                e.printStackTrace();
                LOGGER.error("DataExports.exportIoisUpdatedByLender.SQLException",e);
                isError = true;
            } catch (IOException e) {
                e.printStackTrace();
                LOGGER.error("DataExports.exportIoisUpdatedByLender.IOException",e);
                isError = true;
            }

        } catch (ClassNotFoundException e) {
            e.printStackTrace();
            LOGGER.error("DataExports.exportIoisUpdatedByLender.ClassException",e);
            isError = true;
        ...
        if (isError) {
            LOGGER.debug("DataExports.exportIoisUpdatedByLender Error");
            return "";
        } else {
            LOGGER.debug("DataExports.exportIoisUpdatedByLender completed");
            return fileFullPath;
        }
    }
